 ...
 */
export function wetnessPatch(porosity: number): string {
...
export function detailNormalPatch(scale: number, strength: number): string {
 ...
 */
export function triplanarDetailPatch(scale: number, strength: number): string {
 ...
 */
export function layeredGrowthPatch(mossAmt: number, grimeAmt: number, heightFalloff: number): string {
 ...
 */
export function translucencyPatch(amount: number): string {
